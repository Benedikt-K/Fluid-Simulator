...
namespace SPH_Bachelorprojekt.Simulation.MainSimulation
{
    ...
    class IISPH
    {
        ...
        public void PressureSolve(List<Particle> Particles, float Density, float Gamma, Kernel kernel)
        {
            ///
            ...
            //while (currentIteration < 10)
            {
                ...
                DoPressureSolveIteration(Particles, Gamma, kernel, ref averageDensityError);
        ...
        public void DoPressureSolveIteration(List<Particle> Particles, float Gamma, Kernel kernel, ref float averageDensityError)
        {
            // compute pressureAcc
